    ...
    return (
        <div className='text-white'>
            <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
                ...
                <p className='md:text-2xl text-xl font-bold text-gray-500'>Здесь что то про психологию</p>
                <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-[#000300]'>Приступить</button>
            </div>
        </div>
    )
}
